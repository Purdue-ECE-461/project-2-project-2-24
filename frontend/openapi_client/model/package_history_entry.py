...
class PackageHistoryEntry(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'package_metadata': (PackageMetadata,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, date, package_metadata, action, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, date, package_metadata, action, *args, **kwargs):  # noqa: E501
        """PackageHistoryEntry - a model defined in OpenAPI
