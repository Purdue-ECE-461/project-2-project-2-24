...
class AuthenticationRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'user': (User,),  # noqa: E501
            'secret': (UserAuthenticationInfo,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, secret, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, secret, *args, **kwargs):  # noqa: E501
        """AuthenticationRequest - a model defined in OpenAPI
